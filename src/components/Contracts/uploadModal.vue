<template>
    <div>
        ...
        <div class="modal fade" id="uplaodModal" aria-hidden="true" tabindex="-1">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body pt-0">
                        <div class="container-fluid font-14">
                            <h5 class="modal-title text-center" id="exampleModalToggleLabel2">رفع العقد بعد التوقيع</h5>
                            <div class="row">
                                ...
                                <div class="bg-light-gray p-2 d-flex justify-content-between align-items-center mt-3">
                                    ...
                                    <div>
                                        ...
                                        <button class="delete-btn2 bg-danger rounded-pill">حذف
